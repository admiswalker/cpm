...
docker run --rm -it --name run_cpm_u22_meson_env -v $PWD:$DOCKER_BASE_PATH -w $DOCKER_BASE_PATH -p 8000:8000 $DOCKER_OPTIONS docker_img_cpm_meson_env:latest bash $CMD
