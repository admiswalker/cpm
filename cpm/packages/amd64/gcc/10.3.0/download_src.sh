...
URL=http://ftp.tsukuba.wide.ad.jp/software/gcc/releases/gcc-10.3.0/gcc-10.3.0.tar.xz
...
URL_hash='http://ftp.tsukuba.wide.ad.jp/software/gcc/releases/gcc-10.3.0/sha512.sum'
...
#    echo 'xxxxxxxxxxxxxxxxxxx  gcc-10.3.0.tar.xz' > $CPM_CACHE_DIR/$fName_hash
fi
