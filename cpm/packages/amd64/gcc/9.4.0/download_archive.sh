...
URL1=https://github.com/admiswalker/cpm_archive/raw/main/archive/amd64/gcc/9.4.0/amd64-gcc-9.4.0.tar.xz-00
URL2=https://github.com/admiswalker/cpm_archive/raw/main/archive/amd64/gcc/9.4.0/amd64-gcc-9.4.0.tar.xz-01
fName1=${URL1##*/}       # amd64-gcc-9.4.0.tar.xz-00
fName2=${URL2##*/}       # amd64-gcc-9.4.0.tar.xz-01
