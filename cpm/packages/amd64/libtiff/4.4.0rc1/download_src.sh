...
URL=http://download.osgeo.org/libtiff/tiff-4.4.0rc1.tar.xz
...
#    wget -P $CPM_CACHE_DIR $URL_hash
    echo '49307b510048ccc7bc40f2cba6e8439182fe6e654057c1a1683139bf2ecb1dc1  tiff-4.4.0rc1.tar.xz' > $CPM_CACHE_DIR/$fName_hash
fi
