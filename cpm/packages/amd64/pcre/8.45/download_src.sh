...
URL=https://jaist.dl.sourceforge.net/project/pcre/pcre/8.45/pcre-8.45.tar.bz2
...
#    wget -P $CPM_CACHE_DIR $URL_hash
    echo '4dae6fdcd2bb0bb6c37b5f97c33c2be954da743985369cddac3546e3218bffb8  pcre-8.45.tar.bz2' > $CPM_CACHE_DIR/$fName_hash
fi
