...
std::string cpm::getPath_packsPkgDir    (const std::string& PACKS_DIR, const std::string& architecture, const struct cpm::pkg& p){ return PACKS_DIR + '/' + architecture + '/' + p.name + '/' + p.ver; }
